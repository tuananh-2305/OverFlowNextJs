...
export default function Ask(props: IAskProps) {
  const { textAsk, titleAsk, textEndAsk, wAsk } = props;
  return (
    <Stack
      sx={{
        width: "100%",
    ...
    >
      ...
      ></Stack>
      <Typography sx={{ color: "#000", fontWeight: "550" }}>
        {titleAsk}
      </Typography>
      <Typography sx={{ color: "#333" }}>{textEndAsk}</Typography>
    </Stack>
  );
}
